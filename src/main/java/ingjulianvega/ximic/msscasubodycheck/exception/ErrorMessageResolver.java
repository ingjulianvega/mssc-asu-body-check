...
import ingjulianvega.ximic.msscasubodycheck.configuration.BodyCheckParameters;
...
public class ErrorMessageResolver {
    ...
    private final BodyCheckParameters bodyCheckParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(bodyCheckParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(bodyCheckParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
